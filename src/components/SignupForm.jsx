...
import { Eye, EyeOff, ChevronDown, HelpCircle ,Facebook ,Apple,CircleFadingPlus} from 'lucide-react'
      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col lg:flex-row">
        ...
        <div className="relative flex flex-1 flex-col justify-center p-4 lg:p-12">
          ...
          <p className="text-gray-600">
            ...
            <p><a href="/login" className="text-blue-500 hover:underline">
              Login here!
            </a>
            </p>
          </p>
        ...
        <div className='absolute top-2/4 left-1/4 -translate-x-14  h-20 md:shadowbox' style={{ boxShadow: "32px 10px 300px 44px rgba(0,0,0,0.79)"}}></div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full appearance-none rounded-lg bg-white/60 px-4 py-3 backdrop-blur-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
